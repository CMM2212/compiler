...
import compiler.errors.exceptions.SyntaxException;
...
/**
 * Parse an AST from the lexer.
 *
 * This class is responsible for advancing through tokens in the lexer and generating an
 * abstract syntax tree that represents the code. The root of this AST will be the ProgramNode
 * program.
 */
