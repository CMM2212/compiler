...
public class PrettyPrinter implements ASTVisitor {
    ...
    PrintWriter writer; // Where to pretty print to.

    /**
     * Create a pretty printer and traverse the AST to print it to a Writer.
     *
     * @param parser The parser containing the AST to print.
     * @param writer The output to which the pretty printed text will be sent to.
     */
    public PrettyPrinter(Parser parser, Writer writer) {
