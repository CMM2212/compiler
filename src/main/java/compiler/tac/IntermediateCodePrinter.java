...
public class IntermediateCodePrinter implements ASTVisitor {
     ...
     * @param writer The output to write TAC to.
     */
    public IntermediateCodePrinter(IntermediateCodeGenerator interCode, Writer writer) {
    ...
    public void visit(IdNode node) {
        print(" " + (node.tacName != null ? node.tacName : node.id) + " ");
    }
